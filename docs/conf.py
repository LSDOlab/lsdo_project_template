...
root_doc = 'index' # default: 'index' , previously 'src/welcome'
...
html_theme = 'sphinx_rtd_theme' # other theme options: 'sphinx_book_theme', 'alabaster', 'classic', 'sphinxdoc', 'nature', 'bizstyle', ...
